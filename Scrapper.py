...
# Add title for biomedical literature from MEDLINE.
title_med = "Death+rate+due+to+road+traffic+injuries"

pages = []
page_numbers = list(range(15, 26))
for page_number in page_numbers :
    page = "https://pubmed.ncbi.nlm.nih.gov/?term=" + title_med + "&page=" + str(page_number)
    pages.append(page)
